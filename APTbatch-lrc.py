...
for filename in os.listdir(directory):
	...
	if filename.endswith(".fit") or filename.endswith(".fits") or filename.endswith(".fts"): 
		...
		subprocess.call(["C:/Program Files (x86)/Java/jre1.8.0_201/bin/java.exe", "-Duser.language=en", "-Duser.region=US", "-mx1024M", "-jar", aptJar, "-i", file, "-p", preferences, "-s", "sourceListByAPT", "-o", ofile])
